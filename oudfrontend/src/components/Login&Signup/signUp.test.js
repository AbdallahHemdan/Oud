...
import ResetPassword from './ForgetPassword/ForgotPassword';
jest.mock('axios');
...
describe('Sign up page testing ===>', () => {
  ...
  it('render a Text ', () => {
    const component = shallow(<MainBrand />);
    const Text = component.find(`[data-testid="OudImage"]`);
  ...
  it('login onsubmit ', () => {
    ...
    const OnSubmitButton = wrapper.find(`[data-testid="SignInBtns"]`);
    OnSubmitButton.simulate('click');
    let state = {
      email: 'abdallah@gmail.com',
    };
