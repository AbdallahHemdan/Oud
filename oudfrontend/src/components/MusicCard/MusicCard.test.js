...
const setup = (props = {}) => {
    const component = shallow(
        <MusicCard.WrappedComponent {...props} />
    )
    return component;
}
...
describe('Music Card Component', () => {
    ...
    beforeEach(() => {
        const item = {
            ...
            "public": true,
            "image": "https://i.pinimg.com/736x/00/a1/3c/00a13cf897548091f4042cba761ef00d--cd-cover-dance-music.jpg",
            "type": "playlist"
        }
        const props = {
            item: item
    ...
    it('Should render Card in right way', () => {
